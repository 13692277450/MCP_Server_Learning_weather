...
################################################################################
## Form generated from reading UI file 'superAIWindow.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_SaveCoversationRecords = QPushButton(self.centralwidget)
        self.pushButton_SaveCoversationRecords.setObjectName(u"pushButton_SaveCoversationRecords")
        self.pushButton_SaveCoversationRecords.setMinimumSize(QSize(0, 40))

        self.formLayout_MenuBar.setWidget(7, QFormLayout.ItemRole.SpanningRole, self.pushButton_SaveCoversationRecords)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_6.setText(QCoreApplication.translate("MainWindow", u"LOAD RECORDS", None))
        self.pushButton_SaveCoversationRecords.setText(QCoreApplication.translate("MainWindow", u"SAVE RECORDS", None))
